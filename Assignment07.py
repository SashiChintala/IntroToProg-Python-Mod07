...
#   Sashi Chintala, 12/01/2024,Added more to the starter script
# ------------------------------------------------------------------------------------------ #
...
class Person:
    def __init__(self, first_name:str, last_name:str):
        self.first_name = first_name # cannot use outside person class
    ...
    def first_name(self, value:str)->None:
        """
        Sets the first name, while doing the validations
    ...
    def last_name(self) -> str:
        ...
        :return: The last  name, formatted as a title
        """
...
class Student(Person):  #inherit everything from person class
